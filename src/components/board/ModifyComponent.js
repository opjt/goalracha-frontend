  ...
  return (
    <div className="rounded border-2 border-100 mt-10 m-2 p-4">
      ...
      <input
        ...
        className="input input-bordered w-full max-w-l mb-4 text-base" // text-base 클래스 추가: 폰트 크기를 일반 크기로 설정합니다.
        name="title"
        value={board.title}
      ...
      <textarea
        ...
        className="textarea textarea-bordered w-full max-w-l mb-4 text-base h-64" // text-base 클래스 추가: 폰트 크기를 일반 크기로 설정합니다.
        name="content"
        value={board.content}
        onChange={handleChangeBoard}
      />
